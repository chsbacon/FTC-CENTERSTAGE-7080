...
public class KookyClawTrajectories {
    ...
    public static Action getPurplePixelTraj(DriveShim drive, StartingPosition startingPosition, Team team, SpikeMarkLocation spikeMarkLocation, Action clawReleaseAction){
    ...
    public static Action getPurpleOnlyFinishTraj(DriveShim drive, StartingPosition startingPosition, Team team, SpikeMarkLocation spikeMarkLocation){
    ...
    public static Action getTrajToBackboard(DriveShim drive, StartingPosition startingPosition, Team team, SpikeMarkLocation spikeMarkLocation){
    ...
    public static Action getTrajToParkFromBackboard(DriveShim drive, Team team, SpikeMarkLocation spikeMarkLocation){
