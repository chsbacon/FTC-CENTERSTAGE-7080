...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.000764716;
        public double lateralInPerTick = 0.0005635425068321747;
        public double trackWidthTicks = 14618.106896523253;

        // feedforward parameters (in tick units)
        public double kS = 1.01753648927783;
        public double kV = 0.00014986444717621157;
    ...
    @NonNull
    public IMU initializeIMU(HardwareMap hardwareMap) {
        final IMU imu;
        imu = hardwareMap.get(IMU.class, "imu");
        IMU.Parameters parameters = new IMU.Parameters(new RevHubOrientationOnRobot( // THIS IS THE EXPANSION HUB IMU!!!!
